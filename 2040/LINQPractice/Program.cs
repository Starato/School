...
namespace LINQPractice
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var kitchenProductsFunctional = products.Where(prodcut => (prodcut.Category == ProductCategory.Kitchen));
            ...
            var computerProductsCostingMoreThan100 = from product in products where product.Price > 100.00 & product.Category == ProductCategory.Computers select product;
            ...
            var lowStock = from product in products where product.StockedQuantity < 20 select (product.Title, product.StockedQuantity);
            var lowStockFunctional = products.Where(product => product.StockedQuantity < 20).Select(product => (product.Title, product.StockedQuantity));
            ...
            var lowStockOrderedByStockedQuantity = from product in products where product.StockedQuantity < 20 orderby product.StockedQuantity ascending select (product.Title, product.StockedQuantity);
            var lowStockOrderedByStockedQuantityFunctional = products.Where(product => product.StockedQuantity < 20).OrderBy(product => product.StockedQuantity).Select(product => (product.Title, product.StockedQuantity));
